...
mysqli_multi_query($con,$sql_save); 
    ...
    if ($dbexists==0) {
        ...
        mysqli_multi_query($con,$sql_save);    
         ...
         $sql_save = "INSERT INTO $dbname.sm10_set (create_date, update_date, last_access_date, journal_id, help_shown, theme_type, smartm_software_version) VALUES (NOW(), NOW(), NOW(),1,0,0, 13); ";
          mysqli_multi_query($con,$sql_save);
